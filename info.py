...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Movies Unloaded Network ™](https://t.me/real_MoviesAdda2)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Anime Unloaded ™](https://t.me/Anime_Unloade$)</b> ↭  🔥")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n‌‌‌‌IMDb Data by: @Movies_Unloaded_Network \n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10 \n\n♥️ we are nothing without you ♥️ \n\n💛 Please Share Us 💛\n\n⚠️Click on the button 👇 below to get your query privately")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','pro_morningstar') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','Anime_Unloaded') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Movies_Unloaded_Network') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','pro_morningstar')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "The_Anime_Society") #[ without @ ]
...
OWNER_USERNAME = "pro_morningstar"
...
DOWNLOAD_TEXT_URL = "https://t.me/Movies_Unloaded_Network"

# Custom Caption Under Button #
CAPTION_BUTTON = "Anime Channel"
CAPTION_BUTTON_URL = "https://t.me/Anime_Unloaded"
