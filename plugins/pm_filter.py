...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/Movies_Unloaded_Network')
        ] 
    )
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @pro_morningstar ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Love by @pro_morningstar ♥️')
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                button = InlineKeyboardButton('▶ 🖥️Gen Stream / 🚀Download Link', callback_data=f'generate_stream_link:{file_id}')
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/Movies_Unloaded_Network')
        ], [
            InlineKeyboardButton('🙆🏻 Help 🦾', callback_data='help'),
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
        ],[
            InlineKeyboardButton('Movies Channel', url='https://telegram.me/Movies_Unloaded2')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        await query.answer('♥️ Love By @Pro_Morningstar ♥️')
        ...
        try:
            ...
            await log_msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🚀web Download", url=lazy_download),  # we download Link
                                                    InlineKeyboardButton('▶🖥️Stream online', url=lazy_stream)]])  # web stream Link
            )
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🐞 REPORT BUG 🐞", url=f"https://telegram.me/The_Anime_Society")
            ],[
                InlineKeyboardButton(text=f"⚡️ Follow On Instagram 🦋", url=f"https://www.instagram.com/pro_morningstar")
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"⚡️ Follow On Instagram 🦋", url=f"https://www.instagram.com/pro_korningstar")
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ to ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/Movies_Unloaded_Network'),
        ] 
    )
    if offset != "":
